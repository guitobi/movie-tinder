...
"
      ...
      <button
        onClick={onOpenModal}
        className="bg-pink-800 text-stone-300 font-semibold rounded-xl px-6 py-2 text-xl shadow-[0px_0px_100px_0px_rgba(195,34,128,0.25)]"
      >
        Create Room
      </button>
      {isModalOpen && <UserNameInput onClose={setIsModalOpen} />}
    </div>
  );
};
export default Home;
